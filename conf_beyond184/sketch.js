...
function draw() {
    ...
    frameTime += (millis() - time);
    //print info
    fill(0,0,0);
    frameAverage = (frameTime / frameCount);
    text("avg frame: " + frameAverage + " avg fps: " + (1000 / frameAverage) + 
         "\nMouse X = " + parseInt(mouseX/resX) + " | Mouse Y = " + parseInt(mouseY/resY) +
